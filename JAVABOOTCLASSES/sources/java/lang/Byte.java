...
public final class Byte {
	...
	public static String toString(byte val) {
		if (val == Byte.MIN_VALUE) { /* because the -val trick doesn't work with -128 since 128 is not in range */
			return "-128";
		}
	...
	public static byte parseByte(String s, int radix) {
		...
		int pos = 0;
		int val = 0; // has to be int since 128 does not fit in a byte, yet may occur while parsing "-128"
